    ...
    return (
        <div className={`flex flex-col md:flex-row items-center justify-center h-[100svh] bg-gray-200 p-2 sm:p-4 md:p-0`}>
            <div className={`h-full flex-1 flex-col justify-end px-4 py-8 hidden md:flex`}>
                <h1 className={`font-gfs_didot text-4xl font-extrabold text-indigo-600`}>Inventory Management System</h1>
            ...
            <div className={`h-fit md:h-full w-[90%] md:flex-1 bg-white shadow-lg rounded-lg p-6`}>
                {children}
            </div>
        </div>
    );
